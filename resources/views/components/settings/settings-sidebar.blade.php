<div class="flex flex-nowrap overflow-x-scroll no-scrollbar md:block md:overflow-auto px-3 py-6 border-b md:border-b-0 md:border-r border-slate-200 min-w-60 md:space-y-3">
    ...
    <div>
        ...
        <ul class="flex flex-nowrap md:block mr-3 md:mr-0">
            ...
            {{-- <li class="mr-0.5 md:mr-0 md:mb-0.5">
                <a class="flex items-center px-2.5 py-2 rounded whitespace-nowrap @if(Route::is('apps')){{ 'bg-indigo-50' }}@endif" href="{{ route('apps') }}">
                    <svg class="w-4 h-4 shrink-0 fill-current text-slate-400 mr-2 @if(Route::is('apps')){{ 'text-indigo-400' }}@endif" viewBox="0 0 16 16">
                    ...
                    <span class="text-sm font-medium @if(Route::is('apps')){{ 'text-indigo-500' }}@else{{ 'text-slate-600 hover:text-slate-700' }}@endif">Connected Apps</span>
                </a>
            </li> --}}
            <li class="mr-0.5 md:mr-0 md:mb-0.5">
                <a class="flex items-center px-2.5 py-2 rounded whitespace-nowrap @if(Route::is('plans')){{ 'bg-indigo-50' }}@endif" href="{{ route('plans') }}">                
                    <svg class="w-4 h-4 shrink-0 fill-current text-slate-400 mr-2 @if(Route::is('plans')){{ 'text-indigo-400' }}@endif" viewBox="0 0 16 16">
                        <path d="M5 9h11v2H5V9zM0 9h3v2H0V9zm5 4h6v2H5v-2zm-5 0h3v2H0v-2zm5-8h7v2H5V5zM0 5h3v2H0V5zm5-4h11v2H5V1zM0 1h3v2H0V1z" />
                    </svg>
                    <span class="text-sm font-medium @if(Route::is('plans')){{ 'text-indigo-500' }}@else{{ 'text-slate-600 hover:text-slate-700' }}@endif">Plans</span>
                </a>
            </li>
            {{-- <li class="mr-0.5 md:mr-0 md:mb-0.5">
                <a class="flex items-center px-2.5 py-2 rounded whitespace-nowrap @if(Route::is('billing')){{ 'bg-indigo-50' }}@endif" href="{{ route('billing') }}">
                    <svg class="w-4 h-4 shrink-0 fill-current text-slate-400 mr-2 @if(Route::is('billing')){{ 'text-indigo-400' }}@endif" viewBox="0 0 16 16">
                    ...
                    <span class="text-sm font-medium @if(Route::is('billing')){{ 'text-indigo-500' }}@else{{ 'text-slate-600 hover:text-slate-700' }}@endif">Billing & Invoices</span>
                </a>
            </li> --}}
        </ul>
    </div>
    ...
    {{-- <div>
        ...
        <ul class="flex flex-nowrap md:block mr-3 md:mr-0">
            <li class="mr-0.5 md:mr-0 md:mb-0.5">
                <a class="flex items-center px-2.5 py-2 rounded whitespace-nowrap @if(Route::is('feedback')){{ 'bg-indigo-50' }}@endif" href="{{ route('feedback') }}">
                    <svg class="w-4 h-4 shrink-0 fill-current text-slate-400 mr-2 @if(Route::is('feedback')){{ 'text-indigo-400' }}@endif" viewBox="0 0 16 16">
                    ...
                    <span class="text-sm font-medium @if(Route::is('feedback')){{ 'text-indigo-500' }}@else{{ 'text-slate-600 hover:text-slate-700' }}@endif">Give Feedback</span>
                </a>
            </li>
        </ul>
    </div> --}}
