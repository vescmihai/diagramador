...
export class Link extends dia.Link {
    constructor() {
       ...
       /* this.label(0, {
            position: 0.1,  // Posición relativa en el enlace (0 es el inicio, 1 es el final)
            attrs: {
                text: {
                    text: '1',  // Valor de la multiplicidad
                    fill: 'black',  // Color del texto
                    fontSize: 12  // Tamaño de fuente del texto
                },
                rect: {
                    fill: 'white',  // Color de fondo del cuadro de la multiplicidad
                    stroke: 'black',  // Color del borde del cuadro de la multiplicidad
                    strokeWidth: 1  // Ancho del borde del cuadro de la multiplicidad
                }
            }
        });

        this.label(1, {
            position: 0.9,  // Posición relativa en el enlace (0 es el inicio, 1 es el final)
            attrs: {
              text: {
                text: '1',  // Valor de la multiplicidad
                fill: 'black',  // Color del texto
